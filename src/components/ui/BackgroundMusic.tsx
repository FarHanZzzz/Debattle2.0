...
export function BackgroundMusic() {
  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-[100] flex items-center gap-0 sm:gap-2 rounded-full bg-purple-void/85 border border-purple-bright/30 p-1 sm:px-3 sm:py-2 backdrop-blur-md shadow-2xl transition-all duration-300 hover:border-gold/50 group">
      <button
        onClick={togglePlay}
        className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-purple-glow text-white shadow-lg transition-transform duration-300 active:scale-95 cursor-pointer hover:bg-purple-bright"
      ...
      >
        {isPlaying ? (
          ...
          <svg className="h-3 w-3 translate-x-[1px] sm:h-4 sm:w-4 sm:translate-x-[2px]" fill="currentColor" viewBox="0 0 24 24">
